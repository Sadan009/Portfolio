      ...
      <div className="flex items-center h-full justify-between w-[95%] sm:w-[90%] xl:w-[80%] mx-auto">
        ...
        <div className="flex items-center space-x-10">
          ...
          <div className="flex items-center  space-x-4">
            <a href="#contact" className="md:px-10 md:py-3 px-8 py-3 text-blue-800 font-semibold sm:text-base text-sm bg-white hover:bg-gray-400 transition-all duration-200 rounded-lg">
              Hire Me
            </a>
            {/* Burger Menu */}
